...
const location1 = {
  ...
  randCustPerHour: function (){
    ...
    this.randHourlyCustomers.push(Math.floor(Math.random() * (this.maxAvgCust - this.minAvgCust) + this.minAvgCust));
    }
  },
  ...
  randCookieSoldPerHr: function(){
    for (let i = 0; i < this.hoursOpen.length; i++){
    this.cookiesSoldPerHour.push(Math.floor(this.randHourlyCustomers[i] * this.avgCookiesPerSale));
    this.totalCookiesPerDay += this.cookiesSoldPerHour[i];
    }
  },
  render() {
    ...
    for (let i = 0; i < this.hoursOpen.length; i++) {
        ...
        listItem.textContent = this.hoursOpen[i] + ': ' + this.cookiesSoldPerHour[i] + ' cookies';
...
storeLocations[i].randCookieSoldPerHr();
}
console.log(`random customers per hour: ${location1.randHourlyCustomers}`);
console.log(`cookies sold per hour: ${location1.cookiesSoldPerHour}`);
console.log(`total daily cookies sold: ${location1.totalCookiesPerDay}`);
for (let i = 0; i < storeLocations.length; i++){
